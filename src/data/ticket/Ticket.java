 ...
 * @version 1.0
*/
public record Ticket (Long id, String name, Coordinates coordinates, Date creationDate, Integer price, TicketType type, Venue venue) implements Comparable<Ticket>{
    /** 
